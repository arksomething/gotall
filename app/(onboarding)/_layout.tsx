  ...
  return (
    ...
    >
      ...
      >
        ...
        <Stack.Screen name="puberty" />
        <Stack.Screen name="(puberty)/underarm" />
        <Stack.Screen name="(puberty)/facial" />
        <Stack.Screen name="(puberty)/growth" />
        <Stack.Screen name="(puberty)/shoulders" />
        <Stack.Screen name="(puberty)/odor" />
        <Stack.Screen name="(puberty)/acne" />
        <Stack.Screen name="(puberty)/muscles" />
        <Stack.Screen name="(puberty)/voice" />
        <Stack.Screen name="(puberty)/slower" />
        <Stack.Screen name="(puberty)/shave" />
        <Stack.Screen name="(puberty)/analysis" />
